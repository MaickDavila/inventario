...
CREATE TABLE IF NOT EXISTS `inventario_drel`.`usuario_equipo` (
  ...
  INDEX `fk_usuario_equipo_usuario_idx` (`idusuario` ASC),
  INDEX `fk_usuario_equipo_marca_idx` (`idmarca` ASC),
  INDEX `fk_usuario_equipo_tipo_equipo_idx` (`idtipo_equipo` ASC),
  INDEX `fk_usuario_equipo_area_idx` (`idarea` ASC),
  CONSTRAINT `fk_usuario_equipo_usuario`
    FOREIGN KEY (`idusuario`)
    REFERENCES `inventario_drel`.`usuario` (`idusuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_usuario_equipo_marca`
    FOREIGN KEY (`idmarca`)
    REFERENCES `inventario_drel`.`marca` (`idmarca`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_usuario_equipo_tipo_equipo`
